...
function initSpeech(){
    ...
    let voiceBox=document.getElementById("voiceText");
    if(voiceBox){
...
async function sendCall(student){
    ...
    //====================================
    // نمایش دانش آموز در کلاس مربوطه
    //====================================
    ...
    "count-"+call.class_name
    );
    
    
    if(count){
    
    let number=parseInt(count.innerText)||0;
